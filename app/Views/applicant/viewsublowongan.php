                  ...
                  <hr>
                    <div class="row">
                      <div class="col-sm-5">
                        ...
                        <h5>
                        <?php foreach ($sublowongan as $item): ?>
                            <h5><?= $item->alamat ?></h1>
                        <?php endforeach; ?>
                        </h5>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-5">
                        <h6 class="mb-0">Nama Pekerjaan</h6>
                        <h5>
                        <?php foreach ($sublowongan as $item): ?>
                            <h5><?= $item->nama_pekerjaan ?></h1>
                        <?php endforeach; ?>
                        </h5>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-5">
                        ...
                        <h5>
                        <?php foreach ($sublowongan as $item): ?>
                            <h5><?= $item->pendidikan_terakhir ?></h1>
                        <?php endforeach; ?>
                        </h5>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                            <a href="<?= base_url('/edit-sublowongan')?>" class="btn btn-primary" >Edit Data</a>
                            <a href="<?= base_url('/tambah-sublowongan' )?>" class="btn btn-primary" >Tambah Data</a>
                      </div>
                    </div>
                  </div>
                </div>
